...
{
  OpenOrdersState createState()=>OpenOrdersState();
}

class OpenOrdersState extends State<OpenOrders>
{
  List<dynamic>list=[];
                              ...
                              children: [
                                ...
                                Expanded(
                                    ...
                                    Container(
                                        ...
                                        child:Center(
                                          child:Text(list[index]['status']=='1'?'In Progress':
                                          list[index]['status']=='3'?'Open':'Completed',style:TextStyle(fontSize:13,
