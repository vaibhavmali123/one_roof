              ...
              Expanded(
                  ...
                  child:Column(
                    children: [
                      ...
                      SizedBox(height:5,),
                      Image.asset('assets/images/feedback_graphic.png',scale:1,),
                      Text('Tell us about your experience with',
                          style: GoogleFonts.openSans(
                              textStyle: TextStyle(
                                  fontSize:13,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child:RatingBar.builder(
                                    initialRating:1,
                                    minRating:1,
                                    itemSize:constraintHeight>725?28:constraintHeight<720?26:30,
                            ...
                            onPressed: () {
                              ...
                              if (userType=='work') {
                                ...
                                var map={
                                  'sr_no':srNo,
                                  'user_id':userId,
                                  'worker_feedback_comments':comentEditingCtrl.text.toString(),
                                  'worker_feedback':totalRating.toString()
                                };

                                ApiHandler.postApi(ApiProvider.baseUrl,EndApi.workerFeedback,json.encode(map))
                                    .then((value){
                                ...
                                var map={
                                  'sr_no':srNo,
                                  'feedback_comments':comentEditingCtrl.text.toString(),
                                  'feedback_rating':totalRating.toString()
                                };
                                ApiHandler.postApi(ApiProvider.baseUrl,EndApi.feedback,json.encode(map))
                                    .then((value){
